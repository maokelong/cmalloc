...
@ 文件名：
  PrintSizeClasses.py
@ 说明：
  打印所有的 Size Class，以及能够被 SIZE_SDB 整除的 Size Class
"""

# 计算所有 Size Class
CURRENT_SIZE_CLASS = 0
SIZE_CLASSES = []
while CURRENT_SIZE_CLASS < SIZE_SDB:
...
# 计算能够被 SIZE_SDB 整除的 Size Class
MULTIPLE_SIZE_CLASSES = []
for size_class in SIZE_CLASSES:
    if SIZE_SDB % size_class == 0:
        MULTIPLE_SIZE_CLASSES.append(size_class)

print("其中能够被 SIZE_SDB 整除的包括：\n%s\n共计%d个" %
